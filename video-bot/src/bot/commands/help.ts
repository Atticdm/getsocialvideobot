...
/translate <url> [en-ru|ru-en|identity-ru|identity-en|auto] [hume|elevenlabs|terminator-ru|terminator-en|zhirinovsky-ru|zhirinovsky-en] — перевод или переозвучка рилса (при ENABLE_REEL_TRANSLATION)
...
🌐 Перевести видео — выбрать направление и тип перевода (🚀 Hume, 💎 ElevenLabs, 🎯 Голос Терминатора, 🎤 Голос Жириновского)
🎙 Озвучить видео — выбрать язык оригинала и голос (Терминатор или Жириновский)
// Arena publishing functionality is temporarily disabled
